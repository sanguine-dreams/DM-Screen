...
export default function Spells() {
  const { spells, pageSpell, setPageSpell } = useContext(DnDContext);
        ...
        {(spell) => (
          <TableRow key={spell.slug} className="text-left">
            ...
            <TableCell className="level">
              {spell.level != "Cantrip" ? spell.level.slice(0, 3) : spell.level}
            </TableCell>
            <TableCell className="casting">
              {spell.casting_time.slice(0, 10)}
            </TableCell>
